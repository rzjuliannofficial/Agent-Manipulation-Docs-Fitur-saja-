...
def run_calc(excel_path):
    ...
    print("Sorted Qi values (Smartphone):")
    for idx, item in enumerate(sorted_qi):
        print(f"Rank {idx+1}: {item['alt']} Qi={item['qi']:.8f}")

run_calc("output/SWARA_MAIRCA_DETAIL_RUMUS.xlsx")
